...
class PerfilForm(forms.ModelForm):
    ...
    def clean(self, *args, **kwargs):
        cpf_data = self.cleaned_data['cpf']
        validation_error_msgs = {}

        user_db = models.Perfil.objects.filter(cpf=cpf_data).first()

        if not self.usuario:
            if user_db:
                validation_error_msgs['cpf'] = 'CPF ja cadastrado'
...
class UserForm(forms.ModelForm):
    ...
    def clean(self, *args, **kwargs):
        ...
        error_msg_required_field = 'Esta campo e obrigatorio'
